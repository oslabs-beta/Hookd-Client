...
const Header: React.FC = () => {
  ...
  return (
    <div id="header">
      ...
      <motion.p animate = {{x: 100}} transition = {{ ease: 'easeOut', duration: 1}}> A Traspilation and Trasformation tool for Class Components to Functional Components with Hooks. </motion.p>
      <motion.p animate = {{x: 100}} transition = {{ ease: 'easeOut', duration: 1}}> Download our 
